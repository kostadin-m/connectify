...
const CustomChatCard = (props: CustomChatCardProps) => {
    ...
    return (
        <ChatCard
            ...
            avatarStyle={{
                boxShadow: otherMember?.is_online ? "rgb(24 144 255 / 35%) 0px 2px 7px" : "rgb(245 34 45 / 35%) 0px 2px 7px",
                border: otherMember?.is_online ? "1px solid rgb(24 144 255)" : "1px solid rgb(245 34 45)",
            }}
